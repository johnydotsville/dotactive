...
export const CarryIcon: React.FC<IconProps> = ({ size }) => {
  const w = size ?? "100%";
  const h = w;
...
export const MidIcon: React.FC<IconProps> = ({ size }) => {
  const w = size ?? "100%";
  const h = w;
...
export const HardlineIcon: React.FC<IconProps> = ({ size }) => {
  const w = size ?? "100%";
  const h = w;
...
export const SoftSupportIcon: React.FC<IconProps> = ({ size }) => {
  const w = size ?? "100%";
  const h = w;
  ...
  return (
    <svg viewBox="0 0 24 24" width={w} height={h}>
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M4.399 14.667c0-.602-.494-1.09-1.1-1.09h-2.2c-.606 0-1.099.488-1.099 1.09v7.214c0 .602.493 1.09 1.099 1.09h2.2c.607 0 1.1-.488 1.1-1.09v-7.214z" fill="url(#wrist_:r47:_dark)" fill-opacity="0.7"></path>
...
export const HardSupportIcon: React.FC<IconProps> = ({ size }) => {
  const w = size ?? "100%";
  const h = w;
  ...
  return (
    <svg viewBox="0 0 24 24" width={w} height={h}>
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M4.399 15.02c0-.583-.494-1.058-1.1-1.058h-2.2c-.606 0-1.099.475-1.099 1.059v6.998c0 .583.493 1.057 1.099 1.057h2.2c.606 0 1.1-.474 1.1-1.057v-6.998z" fill="url(#wrist_:r1u:_dark)" fill-opacity="0.7"></path>
