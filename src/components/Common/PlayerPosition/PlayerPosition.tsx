...
export function PlayerPosition({ position } : { position: Position }) {
  switch (position) {
    case "POSITION_1": return <PositionCarry />;
    case "POSITION_2": return <PositionMid />;
    case "POSITION_3": return <PositionHardlane />;
    case "POSITION_4": return <PositionSoftSupport />;
    case "POSITION_5": return <PositionHardSupport />;
